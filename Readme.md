...
- Verify logs a warning in release builds, fails in debug. Code is in the macro still executed in release. Message is an optional parameter that will be logged to the console / file logger
-
